...
myAudio.src = "../img/button-mp3.mp3"; // назначение звукового файла
myAudio.play(); // воспроизвести звук

/* конец звук по нажатию на ссылку */
...
// Настройки
var snowCount = 100;  // кол снежинок на экране
var snowColor = new Array("#b9dff4", "#b9dff5", "#b9dff6", "#b9dff7", "#b9dff8");  // цвета
